...
- [x] 每个单元约 20 个单词，每轮默认学习 10 个
- [x] 支持“看英文选中文”“看中文选英文”“英文拼写”三种题型
- [ ] 发音优先使用浏览器 `speechSynthesis`
- [ ] 单词 `imageUrl` 允许为空，前端使用 Emoji 或默认插图兜底
- [x] 学习记录、错词和统计数据保存到 PostgreSQL
- [ ] 不支持跨浏览器、跨设备同步
- [ ] 清除浏览器数据后会生成新的匿名身份
...
- [x] 定义 `data/words.json` 数据格式
- [x] 准备 1 本默认词书
- [x] 创建 5 个单元
- [x] 每个单元准备约 20 个单词
- [x] 为单词填写英文、音标、词性和中文释义
- [x] 为单词填写简单英文例句和中文翻译
- [x] 为常用单词填写 Emoji
- [x] 图片地址允许为空
- [x] 编写导入脚本
...
- [x] `GET /api/v1/dashboard?learnerId=`

### 学习与答题

- [x] `POST /api/v1/study-sessions`
- [x] `GET /api/v1/study-sessions/:id`
- [x] `GET /api/v1/study-sessions/:id/questions`
- [x] `POST /api/v1/study-sessions/:id/answers`
- [x] `POST /api/v1/study-sessions/:id/complete`
- [x] `POST /api/v1/progress/feedback`

### 复习和统计

- [x] `GET /api/v1/review-queue?learnerId=`
